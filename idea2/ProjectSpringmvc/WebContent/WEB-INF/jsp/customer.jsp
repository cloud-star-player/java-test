	...
	<div id="page-wrapper">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<form class="form-inline" method="get" 
				      action="${pageContext.request.contextPath }/customerfindc">
		...
		<div class="row">
            ...
            <c:if test="${list.pageNum!=list.pages}">
                <a class="prev" href="${pageContext.request.contextPath}/customerall?pn=${list.pageNum+1}">&gt;&gt;</a>
                <a class="prev" href="${pageContext.request.contextPath}/customerall?pn=${list.pages}">尾页</a>
            </c:if>
        </div>
					</div>
					<!-- /.panel-body -->
...
//清空新建客户窗口中的数据
	...
	function editCustomer(id) {
	    $.ajax({
	        type:"get",
	        url:"<%=basePath%>customer/getCustomerById/"+id,
	        dataType : "json",
	...
	function deleteCustomer(id) {
	    if(confirm('确实要删除该客户吗?')) {
	    	$.ajax({
                //地址
                url :"<%=basePath%>customer/deletes/"+id,
                //提交方式
                type : "POST",
                //发送请求时所传递的参数
                //返回的数据使用json
